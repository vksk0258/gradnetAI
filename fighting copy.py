...
def create_app():
    ...
    @app.route('/TOEIC/')  # 데코레이터 이용, '/hello' 경로에 클래스 등록
    ...
    @app.route('/TOPIK/')  # 데코레이터 이용, '/hello' 경로에 클래스 등록
    def TOPIK():
        name = str(request.args['name'])
        file_name = name + ".pdf"
    ...
    @app.route('/성적증명서/')  # 데코레이터 이용, '/hello' 경로에 클래스 등록
    def grade():
        name = str(request.args['name'])
        file_name = name + ".pdf"
    ...
    @app.route('/IBT/')  # 데코레이터 이용, '/hello' 경로에 클래스 등록
    ...
    #####################################################################################################################################################################################################
    @app.route('/IELTS/')  # 데코레이터 이용, '/hello' 경로에 클래스 등록
    ...
    @app.route('/PBT/')  # 데코레이터 이용, '/hello' 경로에 클래스 등록
    ...
    @app.route('/TEPS/')  # 데코레이터 이용, '/hello' 경로에 클래스 등록
    ...
    @app.route('/졸업증명서/')  # 데코레이터 이용, '/hello' 경로에 클래스 등록
